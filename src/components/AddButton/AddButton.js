...
function AddButton({ onClick }) {
  return (
    <div onClick={onClick} className='flex flex-col items-center justify-center w-full h-[145px] bg-light-green rounded-2xl outline-2 outline-dashed outline-[#56E39F] cursor-pointer'>
